...
const CompanyCard: React.FC<CompanyCardProps> = ({ company, cardWidth }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-shrink-0 flex-col items-center justify-center gap-2 sm:gap-3 rounded-xl sm:rounded-2xl border border-neutral-100 bg-white px-2 xs:px-3 sm:px-4 md:px-6 py-2 xs:py-3 sm:py-4 md:py-5 cursor-default transition-all duration-300"
      style={{
        width: cardWidth,
    ...
    >
      ...
      <div className="flex h-6 xs:h-8 sm:h-10 md:h-12 w-full items-center justify-center">
        {imageError ? (
          <div className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center">
            <span className="text-[8px] xs:text-[10px] text-neutral-400 font-medium">
          ...
          <img
            ...
            className="max-h-5 xs:max-h-6 sm:max-h-8 md:max-h-10 max-w-[60px] xs:max-w-[80px] sm:max-w-[100px] md:max-w-[120px] lg:max-w-[140px] object-contain"
            loading="lazy"
      ...
      {/* Divider */}
      <div className="h-px w-4 xs:w-6 sm:w-8 md:w-10 bg-neutral-200" />

      {/* Name */}
      <span
        className="text-[9px] xs:text-[10px] sm:text-xs md:text-sm font-medium tracking-wide text-neutral-700 text-center px-1"
        style={{ 
...
const InfiniteMarquee: React.FC = () => {
  ...
  return (
    <section className="w-full overflow-hidden bg-white border-t border-b border-neutral-100 py-8 sm:py-12 md:py-16">
      {/* Section heading */}
      <div className="mb-6 sm:mb-8 md:mb-10 text-center px-4">
        <p
          className="text-[10px] xs:text-xs uppercase tracking-[0.18em] sm:tracking-[0.22em] text-neutral-400 font-medium mb-1.5 sm:mb-2"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          Trusted By
        </p>
        <h2
          className="text-xl xs:text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-light text-neutral-800 px-2"
          style={{ 
            fontFamily: "'Cormorant Garamond', serif", 
            letterSpacing: "0.04em",
            fontWeight: 300,
        ...
        <div className="mx-auto mt-3 sm:mt-4 h-px w-12 sm:w-16 bg-neutral-200" />
        <p
          className="text-xs xs:text-sm max-w-md mx-auto mt-3 sm:mt-4 text-neutral-600 italic px-4"
          style={{ 
            fontFamily: "'Cormorant Garamond', serif",
            fontWeight: 400,
          }}
      ...
      <div className="relative">
        {/* Left fade */}
        <div 
          className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 xs:w-16 sm:w-20 md:w-40 bg-gradient-to-r from-white to-transparent" 
        />
        
        {/* Right fade */}
        <div 
          className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 xs:w-16 sm:w-20 md:w-40 bg-gradient-to-l from-white to-transparent" 
        />
