...
export default function AboutHero() {
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-black">
      ...
      {/* Floating orbs - changed to red */}
      <div
        className="absolute top-20 right-[15%] w-64 h-64 sm:w-96 sm:h-96 rounded-full bg-red-600/10 blur-3xl pointer-events-none"
        style={{ animation: "float 7s ease-in-out infinite" }}
      />
      <div
        className="absolute bottom-20 right-[30%] w-48 h-48 rounded-full bg-red-500/8 blur-2xl pointer-events-none"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="max-w-3xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] mb-8">
            Crafted With
            <br />
            <span className="italic text-red-500">Intention.</span>
            <br />
            Built to Last.
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#story"
              className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-red-900/40 text-sm"
            >
