...
export default function CollectionHeader({ sortValue, onSortChange }: Props) {
  return (
    <>
      ...
      <div className="border-b border-maroon/10 pb-6 mb-8 bg-[#F8F4F0]">
        {/* Breadcrumb */}
              ...
              <a
                ...
                className={`text-[11px] font-bold tracking-widest uppercase transition-colors
                  ${i === CONTENT.breadcrumbs.length - 1
                    ...
                    : "text-black/50 hover:text-maroon"}`}
              >
                {crumb}
              </a>
            </span>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-maroon/20 text-black text-sm font-medium
