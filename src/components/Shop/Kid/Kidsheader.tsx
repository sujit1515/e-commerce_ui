...
const CONTENT = {
  breadcrumbs: ["Home", "Kids' Collection"],
  title:       "Little Ones Edit",
  description: "Playful styles for the smallest fashionistas. Soft fabrics, bright colours, big personalities.",
};
...
export default function KidsCollectionHeader({ sortValue, onSortChange }: Props) {
  return (
    <>
      <style>{`
        :root {
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="relative">
              ...
              <svg
                className="absolute right-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-black/40 pointer-events-none"
